...
header("Content-Disposition: attachment; filename=\"resource_plan_gantt_category.xlsx\"");
...
$objPHPExcel = new PHPExcel();
	...
	function resourcePlan( $res_type, $project_id, $res_category, $proj_date_range, $rw ){
		...
		if($row_count != 0){
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, $rw, $res_type);
...
// Write the Excel file to filename resource_plan_gantt_category.xlsx 
