...
window.dhtmlx || (dhtmlx = function(t) {
    ...
    gantt = {version: "2.1.0"}, dhtmlxEventable = function(obj) {
            ...
            if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(l.$level), d == t.config.id && (d = null)), this.isTaskExists(d)) {
                ...
                if (_.y + o.offsetHeight / 2 < r) {
                    ...
                    if (g) {
                        ...
                        return this.moveTask(l.id, -1, g.parent), i.target = "next:" + g.id, void 0
                }
                ...
                if (i)
                    if (i.mode && i.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + i.mode]) {
                        ...
                        if (gantt._is_flex_task(s) && i.mode != gantt.config.drag_mode.progress)
                            return this.clear_drag_state(), void 0;
                        i.id = a;
        ...
        if (this.config.start_date && this.config.end_date)
            return this._min_date = this.date[t + "_start"](new Date(this.config.start_date)), this._max_date = this.date[t + "_start"](new Date(this.config.end_date)), void 0;
        ...
        var l = 0 !== t.$index % 2, _ = gantt.templates.task_row_class(t.start_date, t.end_date, t), h = "gantt_task_row" + (l ? " odd" : "") + (_ ? " " + _ : "");
        ...
        return this._task_area_pulls || (this._task_area_pulls = {}), this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"), this._task_area_renderers[t] = {render_item: function(a, s) {
                ...
                if (s = s || n, i && !i(a))
                    return this.remove_item(a.id), void 0;
